-- Cognos-sourced version of dbo.usp_GetPositionBudgetsLocal.
-- Returns the same result set from dbo.PositionBudgetsCognos (UCP-391 Funding Entry,
-- campus-wide) plus IS_FUTURE, which marks funding entries effective after the load date.
-- ComboCode is returned as ACCOUNT_CODE to keep the result set shape.
CREATE PROCEDURE dbo.usp_GetPositionBudgetsCognos
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            -- 1.0-FTE monthly rate; the client computes actual salary as MONTHLY_RATE * FTE.
        ...
        EXEC [dbo].[usp_LogProcedureExecution]
            @ProcedureName = 'dbo.usp_GetPositionBudgetsCognos',
