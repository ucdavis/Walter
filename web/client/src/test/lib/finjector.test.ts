...
describe('buildFinjectorUrl', () => {
  it('builds the PPM chart string with the placeholder expenditure type', () => {
    expect(buildFinjectorChartString('FPAENM2341', 'BIOIDV', 'AENM002')).toBe(
      'FPAENM2341-BIOIDV-AENM002-522201'
    );
  });
