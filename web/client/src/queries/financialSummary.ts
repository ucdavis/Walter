...
export interface FinancialSummaryRow {
  ...
  financialDeptGName?: string | null; fiscalYear?: number | null;
  fund?: string | null;
  fundName?: string | null; // Hierarchy ancestor levels (0 = top rollup .. 5 = nearest parent) for Fund/Activity/NaturalAccount.
  fundParentLevel0Code?: string | null; fundParentLevel0Name?: string | null;
  fundParentLevel1Code?: string | null; fundParentLevel1Name?: string | null;
  fundParentLevel2Code?: string | null; fundParentLevel2Name?: string | null;
  fundParentLevel3Code?: string | null; fundParentLevel3Name?: string | null;
  fundParentLevel4Code?: string | null; fundParentLevel4Name?: string | null;
  fundParentLevel5Code?: string | null; fundParentLevel5Name?: string | null;
  income: number; naturalAccount?: string | null;
  naturalAccountName?: string | null; naturalAccountParentLevel0Code?: string | null;
  naturalAccountParentLevel0Name?: string | null; naturalAccountParentLevel1Code?: string | null;
  naturalAccountParentLevel1Name?: string | null; naturalAccountParentLevel2Code?: string | null;
  naturalAccountParentLevel2Name?: string | null; naturalAccountParentLevel3Code?: string | null;
  naturalAccountParentLevel3Name?: string | null; naturalAccountParentLevel4Code?: string | null;
  naturalAccountParentLevel4Name?: string | null; naturalAccountParentLevel5Code?: string | null;
  naturalAccountParentLevel5Name?: string | null; net: number;
